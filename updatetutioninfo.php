  ...
  color: #A92A2A;">'.$succs_message.'</div>';
											...
											<div class="itemrow">
									  			...
									  			<div style="width: 80%; float: left;">
									  				<div class="divp50"><input <?php $medium1=strstr($medium, "Bangla"); if($medium1 != '') echo 'checked'; ?> type="checkbox" name="medium_list[]" value="Hindi"><span>Hindi</span></div>
											...
											<div class="itemrow">
									  			...
									  			<div style="width: 80%; float: left;">
									  				<div class="divp50"><input <?php $sub1=strstr($sub, "Bangla"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Hindi"><span>Hindi</span></div>
